...
func (c *toDoServiceProtobufClient) List(ctx context.Context, in *ListReq) (*ListResp, error) {
...
func (c *toDoServiceProtobufClient) Get(ctx context.Context, in *GetReq) (*ToDo, error) {
	ctx = ctxsetters.WithPackageName(ctx, "todo")
	ctx = ctxsetters.WithServiceName(ctx, "ToDoService")
...
func (c *toDoServiceProtobufClient) Create(ctx context.Context, in *CreateReq) (*ToDo, error) {
	ctx = ctxsetters.WithPackageName(ctx, "todo")
	ctx = ctxsetters.WithServiceName(ctx, "ToDoService")
...
func (c *toDoServiceProtobufClient) Update(ctx context.Context, in *UpdateReq) (*ToDo, error) {
	ctx = ctxsetters.WithPackageName(ctx, "todo")
	ctx = ctxsetters.WithServiceName(ctx, "ToDoService")
...
func (c *toDoServiceProtobufClient) Delete(ctx context.Context, in *DeleteReq) (*DeleteResp, error) {
	ctx = ctxsetters.WithPackageName(ctx, "todo")
	ctx = ctxsetters.WithServiceName(ctx, "ToDoService")
...
func (c *toDoServiceJSONClient) List(ctx context.Context, in *ListReq) (*ListResp, error) {
	ctx = ctxsetters.WithPackageName(ctx, "todo")
	ctx = ctxsetters.WithServiceName(ctx, "ToDoService")
	ctx = ctxsetters.WithMethodName(ctx, "List")
	out := new(ListResp)
...
func (c *toDoServiceJSONClient) Get(ctx context.Context, in *GetReq) (*ToDo, error) {
	ctx = ctxsetters.WithPackageName(ctx, "todo")
	ctx = ctxsetters.WithServiceName(ctx, "ToDoService")
	ctx = ctxsetters.WithMethodName(ctx, "Get")
	out := new(ToDo)
...
func (c *toDoServiceJSONClient) Create(ctx context.Context, in *CreateReq) (*ToDo, error) {
	ctx = ctxsetters.WithPackageName(ctx, "todo")
	ctx = ctxsetters.WithServiceName(ctx, "ToDoService")
	ctx = ctxsetters.WithMethodName(ctx, "Create")
	out := new(ToDo)
...
func (c *toDoServiceJSONClient) Update(ctx context.Context, in *UpdateReq) (*ToDo, error) {
	ctx = ctxsetters.WithPackageName(ctx, "todo")
	ctx = ctxsetters.WithServiceName(ctx, "ToDoService")
	ctx = ctxsetters.WithMethodName(ctx, "Update")
	out := new(ToDo)
...
func (c *toDoServiceJSONClient) Delete(ctx context.Context, in *DeleteReq) (*DeleteResp, error) {
	ctx = ctxsetters.WithPackageName(ctx, "todo")
	ctx = ctxsetters.WithServiceName(ctx, "ToDoService")
	ctx = ctxsetters.WithMethodName(ctx, "Delete")
	out := new(DeleteResp)
...
func (s *toDoServiceServer) ServeHTTP(resp http.ResponseWriter, req *http.Request) {
	...
	switch req.URL.Path {
	case "/twirp/todo.ToDoService/List":
		s.serveList(ctx, resp, req)
		return
	case "/twirp/todo.ToDoService/Get":
		s.serveGet(ctx, resp, req)
		return
	case "/twirp/todo.ToDoService/Create":
		s.serveCreate(ctx, resp, req)
		return
	case "/twirp/todo.ToDoService/Update":
		s.serveUpdate(ctx, resp, req)
		return
	case "/twirp/todo.ToDoService/Delete":
...
func (s *toDoServiceServer) serveList(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
...
func (s *toDoServiceServer) serveListJSON(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "List")
	...
	func() {
		...
		respContent, err = s.ToDoService.List(ctx, reqContent)
	}()
...
func (s *toDoServiceServer) serveListProtobuf(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "List")
	ctx, err = callRequestRouted(ctx, s.hooks)
	if err != nil {
...
func (s *toDoServiceServer) serveGet(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	header := req.Header.Get("Content-Type")
	i := strings.Index(header, ";")
	if i == -1 {
		i = len(header)
...
func (s *toDoServiceServer) serveGetJSON(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "Get")
	ctx, err = callRequestRouted(ctx, s.hooks)
	if err != nil {
	...
	func() {
		defer ensurePanicResponses(ctx, resp, s.hooks)
		respContent, err = s.ToDoService.Get(ctx, reqContent)
	}()
	...
	if respContent == nil {
		s.writeError(ctx, resp, twirp.InternalError("received a nil *ToDo and nil error while calling Get. nil responses are not supported"))
		return
	}
...
func (s *toDoServiceServer) serveGetProtobuf(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "Get")
	ctx, err = callRequestRouted(ctx, s.hooks)
	if err != nil {
...
func (s *toDoServiceServer) serveCreateJSON(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	...
	func() {
		defer ensurePanicResponses(ctx, resp, s.hooks)
		respContent, err = s.ToDoService.Create(ctx, reqContent)
	}()
	...
	if respContent == nil {
		s.writeError(ctx, resp, twirp.InternalError("received a nil *ToDo and nil error while calling Create. nil responses are not supported"))
		return
	}
...
func (s *toDoServiceServer) serveUpdate(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	header := req.Header.Get("Content-Type")
	i := strings.Index(header, ";")
	if i == -1 {
		i = len(header)
...
func (s *toDoServiceServer) serveUpdateJSON(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "Update")
	ctx, err = callRequestRouted(ctx, s.hooks)
	if err != nil {
	...
	func() {
		defer ensurePanicResponses(ctx, resp, s.hooks)
		respContent, err = s.ToDoService.Update(ctx, reqContent)
	}()
	...
	if respContent == nil {
		s.writeError(ctx, resp, twirp.InternalError("received a nil *ToDo and nil error while calling Update. nil responses are not supported"))
		return
	}
...
func (s *toDoServiceServer) serveUpdateProtobuf(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "Update")
	ctx, err = callRequestRouted(ctx, s.hooks)
	if err != nil {
...
func (s *toDoServiceServer) serveDelete(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	header := req.Header.Get("Content-Type")
	i := strings.Index(header, ";")
	if i == -1 {
		i = len(header)
...
func (s *toDoServiceServer) serveDeleteJSON(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "Delete")
	ctx, err = callRequestRouted(ctx, s.hooks)
	if err != nil {
	...
	// Call service method
	var respContent *DeleteResp
	func() {
		defer ensurePanicResponses(ctx, resp, s.hooks)
		respContent, err = s.ToDoService.Delete(ctx, reqContent)
	}()
	...
	if respContent == nil {
		s.writeError(ctx, resp, twirp.InternalError("received a nil *DeleteResp and nil error while calling Delete. nil responses are not supported"))
		return
	}
...
func (s *toDoServiceServer) serveDeleteProtobuf(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "Delete")
	ctx, err = callRequestRouted(ctx, s.hooks)
	if err != nil {
